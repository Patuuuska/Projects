...
<html>
<head>
	<title>System Obsługi Stomatologa</title>
...
<nav class="navbar bg-body-tertiary">
  <div class="container-fluid">
    <a class="navbar-brand">
      ...
      <img src="porady_grafika/logo.jpg" alt="Logo" width="240" height="110" class="d-inline-block align-text-top" href="main_dc.php">
      <h4><em>
      <?php
      echo"<h4> System Obsługi Gabinetu Stomatologicznego ";
        echo "</br><h2>Witaj ".$_SESSION['Name']." - ".$_SESSION['Specjalizacja'];
        ?> 
        </h5>
    </a>
  </div>
...
<a href="powiadomienia_lekarz.php"> <button  id="block"><h4>Powiadomienia
<?php
if($ile>0)
    echo "(".$ile.")</h4>";
?>
</button> </a>  
<a href="kalendarz_lekarz.php"> <button id="block2"><h4>Kalendarz</h4></button> </a>
<a href="magazyn.php"> <button id="block2"><h4>Magazyn</h4></button> </a>
<a href="kartoteka.php"> <button id="block2"><h4>Pacjenci</h4></button> </a>
<a href="logout.php"> <button id="block3"><h4>Wyloguj</h4></button> </a>
